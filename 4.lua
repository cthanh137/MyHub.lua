...
function Library:CreateWindow(options)
  ...
  function Elements:AddDropdown(name, options, isMulti, callback, infoData)
    ...
    -- HÀM REFRESH (Sửa lại để không lỗi UI)
    ...
    -- Copy y nguyên logic đóng mở của bạn
    ...
    local ret = { SetValues = Refresh, Set = internalSet, Get = function() return selected end }
    Window.ConfigElements[name] = ret
    return ret -- BẮT BUỘC CÓ DÒNG NÀY ĐỂ KHÔNG LỖI BIẾN NIL
end
